...
const publications = [
  ...
  { name: "Mob Journal", issue: "NISCHITHA · THE ART OF BEING" },
  { name: "SoleDXB", issue: "Street Style Coverage" },
];
  ...
  return (
    <div className="pt-28 pb-24 px-6 md:px-14">
      ...
      >
        ...
        <h1 className="font-display text-[clamp(3.5rem,10vw,9rem)] leading-none text-bone">
          VISHAL DEY
        </h1>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-start mb-24">
        ...
        >
          <div className="space-y-5 font-sans font-light text-bone/70 leading-relaxed text-base">
            <p>
              I&apos;m Vishal Dey — a photographer with an eye for the quiet, the raw, and the cinematic. 
              My work spans editorial portraiture, street photography, and fashion, always searching 
              for the moment where light and emotion collide.
            </p>
            <p>
              Having been published in magazines like <em className="text-bone italic">Elléments</em> and{" "}
              <em className="text-bone italic">7HuesMag</em>, I bring a magazine-level sensibility 
              to every frame — whether in a studio or on the streets of a city.
            </p>
            <p>
              Photography, for me, is less about the camera and more about presence — being in the 
              right place, at the right moment, with the right intention.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <Link
              href="/gallery"
              className="bg-gold text-ink px-8 py-3 font-sans text-xs tracking-widest uppercase hover:bg-bone transition-colors"
            >
              See My Work
            </Link>
            <a
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-px bg-bone/10">
          {publications.map((pub, i) => (
            <div
              key={i}
              className="bg-ink p-8 flex justify-between items-center group hover:bg-bone/5 transition-colors"
            >
              <div>
